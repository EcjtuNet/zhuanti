...
//
    ...
    $(window).resize(function () {
        ...
        if (win_w < 940) {
            ...
            $(".banner_0_bottom").css({"bottom": $(".banner_0_top li .p").outerHeight() + $(".banner_0_top li .tit").outerHeight() + 20});
            $(".header_warp .logo img").css({width: "90%"});
            if (win_w < 540) {
...
$(function () {
    var xxxban = function () {
        ...
        $(".banner_0 .next,.banner_0 .por").hover(function () {
            clearInterval(interv);
        }, function () {
            interv = setInterval(xx, speed * 1000);
        })
...
$(function () {
    ...
    $("div.tab_tags li").each(function (i) {

        $(this).hover(
            function () {
                $("div.tab_tags li").removeClass("current").eq(i).addClass("current");
                $("div.tab_cont").hide().eq(i).show();
            },
            function () {
